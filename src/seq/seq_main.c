/*
 * seq_main.c — Sequential entry point for the traffic automaton.
 *
 * Usage:
 *   ./bin/traffic_seq <road_length> <density> <max_warmup_steps> <measure_steps>
 *
 ...
 *
 * Output (stderr):
 *   Warmup diagnostic. The benchmark harness reads only stdout.
 */
