...
Una particularidad del script es su operación incremental: si los archivos de
resultados ya existen, la ejecución se omite automáticamente, y el flag
\texttt{--force} fuerza la recolección desde cero.
Las herramientas de Valgrind se restringen a $N \leq 500000$ dado su overhead de
instrumentación, y para los tamaños mayores se escribe un centinela
\texttt{SKIPPED} en los archivos correspondientes para distinguir el caso de salto
intencional del de fallo de ejecución.
...
\texttt{allocate\_int\_array}) acumulan una fracción estadísticamente insignificante.
...
Valgrind Cachegrind, disponible para $N \leq 500000$, refuerza este diagnóstico con
