...
\begin{figure}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/profiling/06_hotspot_inner_gprof.png}
   \caption{Hostspot interno de \texttt{compute\_next\_generation} según gprof para $N = 2000000$}
   \label{fig:gprof_callgraph}
\end{figure}

\begin{figure}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/profiling/07_hotspot_inner_perf.png}
   \caption{Hostspot interno de \texttt{compute\_next\_generation} según perf para $N = 2000000$}
   \label{fig:perf_callgraph}
\end{figure}
...
El throughput se mantiene prácticamente constante en torno a 254--256 Mcells/s a lo
...
\subsubsection{Accesos a memoria por nivel}
\begin{figure}[H]
   \centering
   \includegraphics[width=1\textwidth]{images/profiling/11_perf_mem.png}
   \caption{Accesos a memoria por nivel}
   \label{fig:hotspot_inner}
\end{figure}
