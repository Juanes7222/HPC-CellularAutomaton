...
\input{sections/tests/secuencial.tex}
\input{sections/tests/mpi_noopt.tex}
\input{sections/tests/mpi_opt.tex}



%================================
\subsection{Comparación}
\label{sec:Comparación}

Se muestran las gráficas de comparación de la mejor variante de cada implementación.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/charts/time_final.png}
    \caption{Comparación del tiempo de las mejores variantes}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/charts/speedup_final.png}
    \caption{Comparación del Speedup de las mejores variantes}
\end{figure}